...
> Confidence intervals and Hypothesis tests: 
 ...
 - **In ABtesting, the p-value of H0 (the odds for nondifference) is the parameter we are seeking ?**  
 ...
 - Two Prerequisites
   ...
   - Why comparing **two sample means** instead of going directly to comparing **two sample proportions** ? Because two sample proportions are also two sample means. WTF?! Let me explain: When the RV follows a Bernoulli-Dist(1 / 0), then the **sample mean**(the size of '1' out of n times) becomes the sample proportion. we can get z-statistics.
